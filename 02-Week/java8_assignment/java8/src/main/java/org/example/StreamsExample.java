...
public class StreamsExample {
    ...
    public static void main(final String[] args) {
        ...
        Function<Book, Integer> getPrice = new Function<Book, Integer>() {
            @Override
        ...
        double averagePriceStream = authors.stream()
                .flatMap(author -> author.books.stream())
                .mapToInt(book-> book.price)
                .average()
                .orElse(0.0);

        System.out.println("Average price : $" + String.format("%.2f",averagePriceStream));
        ...
        Predicate<Author> hasPublishedBook = new Predicate<Author>() {
            @Override
            public boolean test(Author author) {
